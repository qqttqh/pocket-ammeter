...
# 请求数据的 PHP 脚本 URL
get_data_url = "http://io.power.xyquan.top/updatePower1.php"
# 更新数据的 PHP 脚本 URL
update_data_url = "http://io.power.xyquan.top/updatePower2.php"

# COOKIE
Cookie = get_cookie()
# Cookie = 'ASP.NET_SessionId=v0ork1qbt3nrckefcbl1sgo2'
print(Cookie)
